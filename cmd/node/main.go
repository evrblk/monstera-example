...
func main() {
	...
	monsteraNode.RegisterApplicationCore(&monstera.ApplicationCoreDescriptor{
		...
		CoreFactoryFunc: func(application *monstera.Application, shard *monstera.Shard, replica *monstera.Replica) monstera.ApplicationCore {
			return monsteraexample.NewLocksCoreAdapter(monsteraexample.NewLocksCore(dataStore, shard.LowerBound, shard.UpperBound))
		},
	})
	monsteraNode.RegisterApplicationCore(&monstera.ApplicationCoreDescriptor{
		Name:                   "Namespaces",
		RestoreSnapshotOnStart: false,
		CoreFactoryFunc: func(application *monstera.Application, shard *monstera.Shard, replica *monstera.Replica) monstera.ApplicationCore {
			return monsteraexample.NewNamespacesCoreAdapter(monsteraexample.NewNamespacesCore(dataStore, shard.LowerBound, shard.UpperBound))
		},
	})
	monsteraNode.RegisterApplicationCore(&monstera.ApplicationCoreDescriptor{
		Name:                   "Accounts",
		RestoreSnapshotOnStart: false,
		CoreFactoryFunc: func(application *monstera.Application, shard *monstera.Shard, replica *monstera.Replica) monstera.ApplicationCore {
			return monsteraexample.NewAccountsCoreAdapter(monsteraexample.NewAccountsCore(dataStore))
		},
	})
